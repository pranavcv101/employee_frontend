...
export const EditEmployee = () => {
  ...
  return (
    ...
    //    >
    <>
      <div className="formhead">Edit Employee</div>
      <form>
        <div className="formgroup">
          <div className="editparentclass">
            ...
            <Input
              ...
              value={editemployee.dateOfJoining.toString().substring(0, 10)}
            ...
            <div className="AddressContainer">
              <Input
                ...
                value={editemployee.address.houseNo}
              ...
              <Input
                ...
                value={editemployee.address.line1}
              ...
              <Input
                ...
                value={editemployee.address.line2}
              ...
              <Input
                ...
                id="Pincode"
                placeholder="Pincode"
                value={editemployee.address.pincode}
